...
function createStore(rootModule, options) {
    ...
    var store = new Store(__assign(__assign(__assign({}, rootModuleOptions), options), { plugins: [injectStore].concat(options.plugins || []) }));
    return store;
}

export { Actions, Context, Getters, Module, Mutations, createMapper, createStore, inject, registerModule, unregisterModule };
