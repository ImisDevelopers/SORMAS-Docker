...
(function (global, factory) {
    ...
    (global = global || self, factory(global.VuexSmartModule = {}, global.Vuex));
    ...
    ***************************************************************************** */
    ...
    function createStore(rootModule, options) {
        ...
        var store = new vuex.Store(__assign(__assign(__assign({}, rootModuleOptions), options), { plugins: [injectStore].concat(options.plugins || []) }));
        return store;
    }
