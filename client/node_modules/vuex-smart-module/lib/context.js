    ...
    Object.defineProperty(Context.prototype, "mutations", {
        get: function () {
            ...
            if (this.mutationsClass) {
                var mutationNames = gatherHandlerNames(this.mutationsClass.prototype, BaseMutations);
    ...
    Object.defineProperty(Context.prototype, "actions", {
        get: function () {
            ...
            if (this.actionsClass) {
                var actionNames = gatherHandlerNames(this.actionsClass.prototype, BaseActions);
